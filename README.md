###### Note: this is a clone of [phusion/baseimage-docker](https://github.com/phusion/baseimage-docker) to facilitate trusted builds via [index.docker.io](https://index.docker.io/).
